...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><?= $producto_DAO['nombre']; ?></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Borrar</a></li>
...
<h3 class="card-title">¿Deseas eliminar este producto?</h3>
</div>


<form class="shadow" action="../app/controllers/almacen/delete.php" method="POST">
   <input type="text" value="<?= $producto_DAO['id_producto']; ?>" name="id_producto" hidden>
  <div class="card-body">
