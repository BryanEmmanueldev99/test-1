...
$sql_compras = "SELECT *,
                ...
                prov.empresa as empresa,prov.email_proveedor as email_proveedor,prov.direccion as direccion_proveedor, us.nombres as nombres_usuario 
                ...
                INNER JOIN tb_proveedores as prov ON co.id_proveedor = prov.id_proveedor WHERE co.id_compra = '$id_get_compra' ";
