               ...
               <form action="" method="get">
                  <div class="mb-3">
                    ...
                    <input
                      type="text"
                      class="form-control"
                      id="nombre_categoria<?php echo $id_proveedor_DAO; ?>"
                      value="<?php echo $proveedor_DAO; ?>"
                    />
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
               <form action="" method="get">
                  <div class="mb-3">
                    <label for="" class="form-label">Nombre de la proveedor:</label><b style="color: red;" class="red">*</b>
